...
import { LayoutDashboard, Plus, FileText, LogOut, ClipboardList } from 'lucide-react';
    ...
    <div className="fixed left-0 top-0 h-screen w-15 bg-[#FAF9F5] border-r border-[#E1E5E9] flex flex-col items-center py-6 gap-4">
      ...
      <nav className="flex flex-col gap-4">
        <div className="group relative">
          <NavLink to="/company/dashboard" end className={iconClasses}>
        ...
        <div className="group relative">
          <NavLink to="/company/create-interview" className={iconClasses}>
        ...
        <div className="group relative">
          <NavLink to="/company/shortlist-resumes" className={iconClasses}>
            <FileText size={22} strokeWidth={1.5} />
          </NavLink>
          <div className={tooltipClasses}>Resume Shortlisting</div>
        </div>

        <div className="group relative">
          <NavLink to="/company/interview-results" className={iconClasses}>
            <ClipboardList size={22} strokeWidth={1.5} />
          </NavLink>
          <div className={tooltipClasses}>Interview Results</div>
        </div>
      </nav>
