...
const CreateCompanyInterview = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await axios.post('http://localhost:8000/company/create-interview', {
      ...
      if (response.status === 201) {
        toast.success('Interview created and email sent successfully!');
      ...
      <div className="w-full max-w-2xl">
        <div className="mb-12 text-center">
          ...
          <p className="text-[#6B6662] font-light">
            Enter the candidate's email and the interview questions.
          </p>
        </div>
